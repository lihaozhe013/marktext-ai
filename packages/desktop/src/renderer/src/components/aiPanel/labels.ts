const createChineseLabels = () => ({
  ...
  reasoningEffortModelDefault: (value?: string) => value ? `默认 - ${value}` : '默认（Provider default）',
  reasoningEffortProviderDefault: 'Provider default',
  verbosity: '会话回答详细程度',
  verbosityModelDefault: (value?: string) => value ? `默认 - ${value}` : '默认（Provider default）',
  verbosityProviderDefault: 'Provider default',
...
const createEnglishLabels = () => ({
  ...
  reasoningEffortModelDefault: (value?: string) => value ? `Model default - ${value}` : 'Model default (Provider default)',
  reasoningEffortProviderDefault: 'Provider default',
  verbosity: 'Session response verbosity',
  verbosityModelDefault: (value?: string) => value ? `Model default - ${value}` : 'Model default (Provider default)',
  verbosityProviderDefault: 'Provider default',
